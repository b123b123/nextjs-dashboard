			...
			<div className="rounded-md bg-gray-50 p-4 md:p-6">
				...
				<div className="mb-4">
					...
					<div className="relative">
						<select aria-describedby="customer-error" id="customer" name="customerId" className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500" defaultValue="">
